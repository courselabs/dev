...
az appservice plan create -g $rgName -n $planName --is-linux --sku S1 --number-of-workers 2 | Out-Null

$appName="labscd-$appId"
echo '* Creating Web App $appName'
az webapp create -g $rgName --plan $planName --runtime dotnetcore:6.0 -n $appName | Out-Null
